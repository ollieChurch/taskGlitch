...
- [x] Write a landing page for logged-out visitors that explains what TaskGlitch does
- [x] Define the value proposition: what makes TaskGlitch different from other task managers?
- [x] Write feature descriptions for the main capabilities:
  - Intelligent task prioritisation
  - Schedule generation ("Glitch It")
  - Break scheduling
  - Dashboard & analytics
- [x] Include a clear call-to-action (sign up / get started)

### Content Sections

- [x] Hero section: tagline + one-sentence description
- [x] How it works: 3-4 step visual explanation
- [x] Features: brief descriptions of key capabilities
- [x] CTA: sign up prompt
...
- [x] Create a landing page view for unauthenticated users (or repurpose the login page)
- [x] Ensure copy is accessible and readable
- [x] Consider SEO basics: meta description, Open Graph tags
